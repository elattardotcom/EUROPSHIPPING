        ...
        <>
          ...
          <Section title="7. Your Rights">
            ...
            <p>
              ...
              <span className="text-orange-400">privacy@codship.com</span> with a copy of your ID. We will respond within 30 days.
            </p>
          </Section>
          ...
          <Section title="9. Contact and Complaints">
            <p>For any questions regarding the protection of your data: <span className="text-orange-400">privacy@codship.com</span></p>
            <p>
