  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white overflow-x-hidden">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 transition-all duration-500"
        style={{
      ...
      >
        <span className="hidden sm:block bg-[#111] text-white text-xs font-semibold px-3 py-1.5 rounded-lg border border-white/10 shadow-lg whitespace-nowrap"
          style={{ opacity: scrolled ? 1 : 0, transition: "opacity 0.3s 0.1s" }}>
          Chat with us
        </span>
        <div className="relative w-14 h-14 rounded-full flex items-center justify-center shadow-2xl"
          ...
          <span className="absolute -top-1 -right-1 w-3.5 h-3.5 rounded-full bg-emerald-400 border-2 border-[#080808] animate-dot" />
        </div>
      </a>
    </div>
  )
