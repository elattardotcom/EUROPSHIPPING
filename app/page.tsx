    ...
    <div className="min-h-screen bg-[#080808] text-white overflow-x-hidden">
          ...
          <div className="marquee-track flex items-center gap-0">
            {[...TICKER, ...TICKER].map((t, i) => (
              <span key={i} className="text-xs text-neutral-500 px-6 flex items-center gap-3">
                {t}<span className="w-px h-3 bg-white/10" />
              </span>
            ))}
          </div>
        </div>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                { icon: PhoneCall, step: "02", label: "Confirmation d'appel",  desc: "Votre équipe confirme la commande et valide l'adresse de livraison",                     color: "#f59e0b", glow: "rgba(245,158,11,0.2)" },
                { icon: Truck,     step: "03", label: "Expédition & Suivi",    desc: "Le colis part, le client reçoit et paie en cash à la livraison",                         color: "#f97316", glow: "rgba(249,115,22,0.2)" },
                { icon: Banknote,  step: "04", label: "Virement 48h",          desc: "CODShip collecte le cash et vous vire sur votre compte en 48h",                          color: "#10b981", glow: "rgba(16,185,129,0.2)" },
              ].map(s => (
      ...
      <section className="py-28 px-6 relative overflow-hidden" style={{ background: "linear-gradient(160deg,#0d0d0d,#080808)" }}>
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <p className="text-neutral-500 text-base mb-10 max-w-lg mx-auto">14 jours d'essai gratuit. Aucune carte bancaire. Configuration en moins de 10 minutes.</p>
          <OpenModalButton step="signup"
            className="group inline-flex items-center gap-2 font-black text-base text-white px-10 py-4 rounded-xl transition-all"
