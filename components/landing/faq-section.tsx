  ...
  en: [
    {
      ...
      a: "As soon as a COD delivery is confirmed, the amount is credited to your CODShip wallet. You can request a transfer at any time — we process all requests within 48 business hours directly to your bank account (IBAN, Wise or crypto).",
    },
    {
      q: "How many Shopify stores can I connect?",
      a: "With the Starter plan: 1 store. Pro: up to 3 stores. Enterprise: unlimited. Connection takes less than 2 minutes via our Shopify app — each new order appears instantly in your CODShip dashboard.",
    },
    {
      q: "Which countries are covered?",
      a: "CODShip currently covers 10 European countries: 🇪🇸 Spain, 🇵🇹 Portugal, 🇮🇹 Italy, 🇷🇴 Romania, 🇧🇬 Bulgaria, 🇭🇺 Hungary, 🇬🇷 Greece, 🇸🇰 Slovakia, 🇸🇮 Slovenia and 🇨🇿 Czech Republic. More markets are being integrated.",
    },
    {
    ...
    {
      q: "How does CODShip secure my data and transactions?",
    ...
    {
      q: "Can I use CODShip with multiple team members?",
